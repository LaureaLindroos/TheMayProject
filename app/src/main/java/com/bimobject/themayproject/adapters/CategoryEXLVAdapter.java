...
public class CategoryEXLVAdapter extends ExpandableListView {
    ...
    public CategoryEXLVAdapter() {
        data = new ArrayList<>();
        helper = new RVAHelper(this);
    }

    @Override
    public void onBindViewHolder(@NonNull RecycleViewAdapter.ProductViewHolder holder, int position) {
    ...
    @NonNull
    @Override
    public RecycleViewAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_layout, parent, false);
        return new RecycleViewAdapter.ProductViewHolder(itemView);
    }

    @Override
    public void onViewDetachedFromWindow(@NonNull RecycleViewAdapter.ProductViewHolder holder) {
